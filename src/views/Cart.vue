            ...
            <div class="flow-root">
              <ul class="-my-8">
                <li v-for="cart in getCart" :key="cart.cart_id"
                  ...
                  <div class="shrink-0">
                    <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="https://dynamic.zacdn.com/ZUdKPvYDCJYtr33ryJ08pF588II=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/jenahara-9720-1093614-4.jpg" alt="" />
                  </div>
