    ...
    <div class="grid md:grid-cols-4 gap-8  mt-10 pl-5">
      <div v-for="product in getProduk.slice(0, 12)" :key="product.slug">
        ...
        <div class="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-gray shadow-md">
          <a href="#">
            <img class="h-50 rounded-t-lg object-cover w-full" src="https://dynamic.zacdn.com/eedj0Dm9Q6sTDucWkfjyw6CsiR4=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/jenahara-9719-1093614-3.jpg" alt="product image" />
          </a>
          <span
